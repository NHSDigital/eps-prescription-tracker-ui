...
describe("mapIntentToPrescriptionTreatmentType", () => {
  ...
  describe("extractPrescribedItems", () => {
    ...
    it("should extract pending cancellation information from extensions", () => {
          ...
          extension: [
            {
              ...
              extension: [
                ...
                {url: "cancellationReason", valueCoding: {display: "Medication error"}}
              ]
            }
          ]
        }
      ...
      const result = extractPrescribedItems(medicationRequests)
      expect(result[0].itemDetails.itemPendingCancellation).toBe(true)
      expect(result[0].itemDetails.cancellationReason).toBe("Medication error")
    })
