...
jest.mock("@/constants/ui-strings/ChangeRolePageStrings", () => {
  const ChangeRolePageStrings = {
...
describe("ChangeRolePage", () => {
  ...
  it("renders error summary if fetch returns non-200 status", async () => {
    ...
    await waitFor(() => {
      ...
      const errorHeading = screen.getByRole("heading", {
        name: ChangeRolePageStrings.errorDuringRoleSelection,
      })
  ...
  //     expect(heading).toHaveTextContent(ChangeRolePageStrings.title)
  //   })

  //   // Verify the page caption
  //   const caption = screen.getByText(ChangeRolePageStrings.caption)
  //   expect(caption).toBeInTheDocument()

  //   // Verify the "Roles without access" section (expander)
  //   const expanderText = ChangeRolePageStrings.roles_without_access_table_title
