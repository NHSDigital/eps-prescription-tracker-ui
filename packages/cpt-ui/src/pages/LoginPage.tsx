      ...
      <Container>
        <Row>
          <Col width="full">
            ...
            <p>
              Note that this is the COGNITO login, and displays the relevant
              information.
            </p>
            <p>
              The auth context carries around the logic and authorisation state,
              but takes no actions (yet) without explicit calls. It could be
              updated to monitor login status, and poll to check for serverside
              token retractions.
            </p>
          </Col>
        </Row>
        ...
        <Row>
          <Col width="full">
            ...
            <Button
              ...
              onClick={mockSignIn}
            >
              Log in with mock CIS2
            </Button>
            <Button id="signout" style={{ margin: "8px" }} onClick={signOut}>
              Sign Out
            </Button>
            ...
            {auth && (
              <>
                ...
                <div>isSignedIn: {auth.isSignedIn.toString()}</div>
