...
export const HEADER_CHANGE_ROLE_TARGET = "/change-role"
export const HEADER_SELECT_YOUR_ROLE_BUTTON = "Select Your Role"
export const HEADER_SELECT_YOUR_ROLE_TARGET = "/select-role"
export const HEADER_PRESCRIPTION_SEARCH_BUTTON = "Search for a prescription"
export const HEADER_PRESCRIPTION_SEARCH_TARGET = "/search"
