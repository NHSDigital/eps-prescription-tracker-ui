...
const userPoolId = "eu-west-2_61GeJTFTN" // This is the User Pool ID from AWS::Cognito::UserPool
const userPoolClientId = "22ndqkf4gnlebjeem361tpk2ql" // This is the Client ID from AWS::Cognito::UserPoolClient
