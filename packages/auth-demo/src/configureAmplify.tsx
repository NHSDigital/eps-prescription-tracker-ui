...
const userPoolId = "eu-west-2_6oDRZNcnP" // This is the User Pool ID from AWS::Cognito::UserPool
const userPoolClientId = "7tid7tf7i7inq0grgntmqei26d" // This is the Client ID from AWS::Cognito::UserPoolClient
