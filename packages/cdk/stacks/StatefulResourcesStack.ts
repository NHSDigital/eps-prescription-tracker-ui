...
export class StatefulResourcesStack extends Stack {
  public constructor(scope: App, id: string, props: StatefulResourcesStackProps){
    ...
    if (allowLocalhostAccess) {
      ...
      new CfnOutput(this, "primaryTokenEndpoint", {
        value: primaryTokenEndpoint,
        exportName: `${props.stackName}:local:primaryTokenEndpoint`
      })
      ...
      new CfnOutput(this, "mockTokenEndpoint", {
        value: mockTokenEndpoint,
        exportName: `${props.stackName}:local:mockTokenEndpoint`
      })
