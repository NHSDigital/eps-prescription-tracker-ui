...
lint-node: compile-node
	...
	npm run lint --workspace packages/testingSupport/clearActiveSessionsTimeout
...
test: compile
	...
	npm run test --workspace packages/testingSupport/clearActiveSessionsTimeout
...
check-licenses-node:
	...
	npm run check-licenses --workspace packages/testingSupport/clearActiveSessionsTimeout
