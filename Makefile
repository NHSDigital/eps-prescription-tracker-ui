...
lint-node: compile-node
	...
	npm run lint --workspace packages/testingSupport/fakeTimerLambda
...
test: compile
	...
	npm run test --workspace packages/testingSupport/fakeTimerLambda
...
check-licenses-node:
	...
	npm run check-licenses --workspace packages/testingSupport/fakeTimerLambda
